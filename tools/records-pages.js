...
'use strict';
const VERSION = '20260917-smooth4';
const PAGES = [
...
function assets(page,base) {
  ...
  return {
    ...
    RECORD_PRE:scripts(['assets/js/records-model.js','assets/data/records-config.js','assets/data/record-covers.js','assets/data/records.js','assets/js/records-view.js']),
